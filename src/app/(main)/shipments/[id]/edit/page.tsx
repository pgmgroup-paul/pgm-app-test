                ...
                {containers.map((c: any) => (
                  <tr key={c.id} className="border-b last:border-none">
                    <td className="py-1 pr-2 pl-3 font-mono text-[11px]">
                      <Link href={`/shipments/${shipment.id}/containers/${c.id}`} className="underline">
                      ...
                      <form
                        action={async (formData: FormData) => {
                          ...
                          if (!containerId || !shipmentId) {
                            redirect(`/shipments/${shipment.id}/edit`);
                          }
      ...
      <div className="space-y-2 rounded-md border px-3 py-3 text-xs">
        ...
        <form
          action={async (formData: FormData) => {
            ...
            // If no container number provided, auto-generate sequential like ContP00001
            if (!containerNumber) {
              ...
              containerNumber = prefix + nextSeq.toString().padStart(5, "0");
            }
